...
using VoiceAssistent.Extensions;
using System.Speech.Recognition;
using VoiceAssistent.Properties;
...
namespace VoiceAssistant
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void VoiceAssistant_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            speechRecognitionEngineParallel.LoadGrammarAsync(new Grammar(new GrammarBuilder(new Choices(await File.ReadAllLinesAsync("DefaultCommands.txt")))));
            ...
            // Loading local data
            CheckBox_isAutorun.IsChecked = Settings.Default.IsAutoRun;
            TextBox_ShotDownTimer.Text = Settings.Default.ShotDownTimer.ToString();
            TextBox_HibernateTimer.Text = Settings.Default.HibernateStateTimer.ToString();
        ...
        private void AutoRunUncheckBoxState()
        {
            ...
            SetAutorunValue.SetValue(false);
        ...
        /// <summary>
        /// Sets new value for shot down timer
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBox_ShotDownTimer_PreviewTextInput(object sender, TextCompositionEventArgs e)
        {
            var newTimerNumber = TextBoxParsing.ParseMethod_ToInt(((TextBox)sender).Text + e.Text);

            if(!newTimerNumber.Equals(0))
                Settings.Default.ShotDownTimer = newTimerNumber;

            Settings.Default.Save();
        }

        /// <summary>
        /// Sets new value for hibernate timer
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TextBox_HibernateTimer_PreviewTextInput(object sender, TextCompositionEventArgs e)
        {
            var newTimerNumber = TextBoxParsing.ParseMethod_ToInt(((TextBox)sender).Text + e.Text);

            if (!newTimerNumber.Equals(0))
                Settings.Default.HibernateStateTimer = newTimerNumber;

            Settings.Default.Save();
        }

        /// <summary>
        /// Sets new value for checkbox by hands.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CheckBox_isAutorun_Click(object sender, RoutedEventArgs e)
        {
            if(CheckBox_isAutorun.IsChecked.Equals(true))
            {
                CheckBox_isAutorun.IsChecked = false;
                Settings.Default.IsAutoRun = false;
            }
            
            if(CheckBox_isAutorun.IsChecked.Equals(false))
            {
                CheckBox_isAutorun.IsChecked= true;
                Settings.Default.IsAutoRun = true; 
            }
